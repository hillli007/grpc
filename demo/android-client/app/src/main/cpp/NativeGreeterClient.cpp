...
CJNIEXPORT jstring JNICALL Java_com_lxl_demo_gprc_GreeterClient_00024CppProxy_native_1SignIn(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef, jstring j_name, jstring j_pwd)
{
    try {
        DJINNI_FUNCTION_PROLOGUE1(jniEnv, nativeRef);
        const auto& ref = ::djinni::objectFromHandleAddress<::grpcdemo::GreeterClient>(nativeRef);
        auto r = ref->SignIn(::djinni::String::toCpp(jniEnv, j_name),
