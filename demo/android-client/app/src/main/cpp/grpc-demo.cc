...
Java_com_lxl_demo_gprc_DemoActivity_signin(JNIEnv *env, jclass type, jstring host_, jint port_, jstring username_, jstring pwd_) {
    ...
    std::string reply = greeter.SignIn("android",username,pwd);
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_lxl_demo_gprc_DemoActivity_heartbeat(JNIEnv *env, jclass type, jstring host_, jint port_, jstring username_, jstring pwd_) {
    ...
    GreeterClientImpl greeter(host_port);
    std::string reply = greeter.HeartBeat("android",username,pwd);
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_lxl_demo_gprc_DemoActivity_logout(JNIEnv *env, jclass type, jstring host_, jint port_, jstring username_, jstring pwd_) {
    ...
    GreeterClientImpl greeter(host_port);
    std::string reply = greeter.LogOut("android",username,pwd);
